...
// TODO: 10/15/2023 upcast и downcast в ссылочных типах. Сделать класс родитель, класс потом с разными методами, посмотреть какие методы доступны после upcast и downcast.
